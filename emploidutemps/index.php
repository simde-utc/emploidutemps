...
<head>
  ...
  <title>Emploi d'UTemps Beta 1.3.1</title>
</head>

<body onLoad='main()'>
  <div id='header'>
    <a id='title' href='/'>Emploi d'UTemps Beta 1.3.1</a>
    <div id='sTitle'></div>
    <div id='bar'></div>
  </div>
  ...
  Futur exporter<button id='toPDF' onClick="$('#skeduler-container').print();"><img src='/emploidutemps/ressources/img/pdf.png' alt='To PDF' /></button>
