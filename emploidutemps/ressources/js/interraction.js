...
function printEtuAndUVList() {
  if (window.toSearch != window.search) {
    ...
    $('#searchResult').load('https://' + window.location.hostname + '/emploidutemps' + '/ressources/php/getEtuAndUVList.php?search=' + search.replace(/^\s+|\s+$/g, '').replace(/_/g, '').replace(/\s/, '%\\_%\\'), function () {
      endLoading();
    });
  }
}
...
function desinscription() {
  $.get('https://' + window.location.hostname + '/emploidutemps' + '/ressources/php/desinscription.php', function (info) {
    popup(info);
  });
}

function reinscription() {
  $.get('https://' + window.location.hostname + '/emploidutemps' + '/ressources/php/reinscription.php', function (info) {
    popup(info);
  });
}

function seeMenu() {
  $.get('https://' + window.location.hostname + '/emploidutemps' + '/ressources/php/parameters.php', function (info) {
    popup(info);
  });
}
